...
from astroos_pipelines.morphometryka import simple_segmentation, measure_morfometry, morfomytry
from astroos_pipelines.tap_clients import PyvoTAPClient

importlib.reload(sys.modules['astroos_pipelines.morphometryka'])
